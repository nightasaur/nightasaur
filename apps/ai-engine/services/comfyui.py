...
from config import COMFYUI_URL, COMFYUI_CHECKPOINT
...
class ComfyUIService:
    ...
    async def generate_image(self, prompt: str, negative: str = "", width: int = 768, height: int = 768, steps: int = 25, cfg: float = 7.5, seed: int = -1) -> dict:
        if not COMFYUI_CHECKPOINT:
            return {"status": "disabled", "msg": "Image model is not configured"}
    ...
    async def generate_spirit(self, name: str, element: str, stage: str = "EGG") -> dict:
        p = {
            "FIRE":f"cute baby fire dragon {name}, small flames, warm glow, original nocturnal creature design, egg hatching, digital art",
            "WATER":f"cute baby water spirit {name}, blue aquatic aura, bubbles, original nocturnal creature design, egg hatching, digital art",
            "SHADOW":f"cute baby shadow creature {name}, dark purple mist, glowing eyes, original nocturnal creature design, egg hatching, digital art",
            "STAR":f"cute baby star dragon {name}, cosmic nebula, sparkles, original nocturnal creature design, egg hatching, digital art",
            "MOON":f"cute baby moon spirit {name}, lunar glow, night sky, original nocturnal creature design, egg hatching, digital art",
            "LIGHT":f"cute baby light fairy {name}, radiant halo, golden glow, original nocturnal creature design, egg hatching, digital art",
            "ILLUSION":f"cute baby mystical fox {name}, ethereal glow, mist, original nocturnal creature design, egg hatching, digital art",
            "NATURE":f"cute baby forest spirit {name}, leaves vines, green glow, original nocturnal creature design, egg hatching, digital art",
            "THUNDER":f"cute baby electric dragon {name}, lightning sparks, electric blue, original nocturnal creature design, egg hatching, digital art",
            "ICE":f"cute baby ice dragon {name}, frost crystals, icy blue glow, original nocturnal creature design, egg hatching, digital art",
        }
        prompt = p.get(element, f"cute baby monster {name}, whimsical, original nocturnal creature design, egg hatching, digital art")
